...
class CollectiveRemoveMembers : AppCompatActivity() {
    ...
    fun removeMembersFromCollective(view: View) {
        try {
            ...
            Toast.makeText(this, "An error occurred when trying to remove members from collective. Try again ", Toast.LENGTH_LONG).show()
            Log.e(tag, "Error when trying to run the removeMembersFromCollective() function",error)
        }
    }
    ...
    private fun removeCollectiveIDFromRemovedMembers(username : String) {
        try {
            ...
            Log.e(tag, "Error when trying to run the removeCollectiveIDFromRemovedMembers() function",error)
        }
    }
